  ...
  return (
    <footer className="border-t border-white/10 bg-[#08080a]">
      <div className="mx-auto grid max-w-7xl gap-12 px-6 py-16 md:grid-cols-2 lg:grid-cols-12">
        <div className="lg:col-span-4">
          ...
          <div className="mt-6 flex gap-3">
            <a
              ...
              aria-label="Facebook"
              className="flex h-11 w-11 items-center justify-center rounded-md border border-white/10 text-zinc-400 transition-all duration-300 hover:-translate-y-1 hover:border-brand-500 hover:text-brand-500"
            >
        ...
        <div className="lg:col-span-3">
          ...
          <ul className="mt-5 space-y-3 text-sm">
            ...
            <li className="text-zinc-400">{site.hours}</li>
          </ul>
          <a
            href={whatsappLink()}
            target="_blank"
      ...
      <div className="border-t border-white/5">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-2 px-6 py-6 text-xs text-zinc-500 sm:flex-row">
